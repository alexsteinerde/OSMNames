...
ALTER TABLE osm_linestring ADD COLUMN name_de TEXT;
ALTER TABLE osm_linestring ADD COLUMN name_en TEXT;
...
ALTER TABLE osm_polygon ADD COLUMN name_de TEXT;
ALTER TABLE osm_polygon ADD COLUMN name_en TEXT;
...
ALTER TABLE osm_point ADD COLUMN name_de TEXT;
ALTER TABLE osm_point ADD COLUMN name_en TEXT;
